...
static void readConfigs(Ctx &ctx, opt::InputArgList &args) {
  ...
  ctx.arg.irpgoProfileSortProfilePath = args.getLastArgValue(OPT_irpgo_profile_sort);
  ctx.arg.compressionSortStartupFunctions = args.hasFlag(OPT_compression_sort_startup_functions, OPT_no_compression_sort_startup_functions, false);
